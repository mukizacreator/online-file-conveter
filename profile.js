...
if (saveAccountBtn) {
  saveAccountBtn.addEventListener("click", async function() {
    ...
    try {
      ...
      // SAVE ACCOUNT - Use showVerificationModal (has default message)
...
if (changePasswordBtn) {
  changePasswordBtn.addEventListener("click", async function() {
    ...
    try {
      ...
      // CHANGE PASSWORD - Use showVerificationModal (has default message)
      const code = await showVerificationModal();
...
if (deleteAccountBtn) {
  deleteAccountBtn.addEventListener("click", async function(e) {
    ...
    try {
      ...
      // DELETE ACCOUNT - Use showVerificationModal (has default message)
      const code = await showVerificationModal();
