/* ============================================
   PROFILE.JS - FIXED BUTTON RESTORE
   ============================================ */
...
/* ============================================
   SAVE ACCOUNT HANDLER - FIXED
   ============================================ */
async function handleSaveAccount(btn) {
  console.log("💾 handleSaveAccount called");
  
  // btn is passed from onclick
  const button = btn || document.getElementById("saveAccountBtn");
...
/* ============================================
   UPLOAD PHOTO - RESTORE BUTTON AFTER UPLOAD
   ============================================ */
if (uploadPhotoBtn && profilePhotoInput) {
  console.log("✅ Setting up Upload Photo restore");
  
  profilePhotoInput.addEventListener("change", async function(e) {
    const file = this.files[0];
    if (!file) {
      // Restore button if no file
    ...
    // File is already being uploaded (button text was changed by onclick)
