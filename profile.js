...
/* ============================================
   UPLOAD PHOTO - CORRECTED (gets button reference)
   ============================================ */
if (uploadPhotoBtn && profilePhotoInput) {
  ...
  // Get the button reference BEFORE the async operation
  ...
  profilePhotoInput.addEventListener("change", async function(e) {
    ...
    try {
      // Use the captured button reference
...
/* ============================================
   SAVE ACCOUNT - CORRECTED (uses this directly)
   ============================================ */
if (saveAccountBtn) {
  ...
  saveAccountBtn.addEventListener("click", async function() {
    ...
    try {
      // Use "this" directly since we're in the button's event listener
      this.disabled = true;
