/* ============================================
   PROFILE.JS - FINAL CORRECTED VERSION
   ============================================ */
...
if (uploadPhotoBtn && profilePhotoInput) {
  ...
  uploadPhotoBtn.addEventListener("click", function(e) {
    ...
    // CHANGE TEXT IMMEDIATELY WHEN CLICKED
  ...
  profilePhotoInput.addEventListener("change", async function(e) {
    ...
    if (!file) {
      // Restore button if no file selected
    ...
    // File is already being uploaded, keep button as "Uploading..."
...
if (saveAccountBtn) {
  ...
  saveAccountBtn.addEventListener("click", async function() {
    ...
    try {
      ...
      // REFRESH PAGE - THIS WILL WORK NOW
      setTimeout(function() {
