...
if (uploadPhotoBtn && profilePhotoInput) {
  ...
  profilePhotoInput.addEventListener("change", function(e) {
    ...
    progressBar.id = 'photoProgressBar';
    ...
    // Add to result area or after upload button
    const resultDiv = document.getElementById('result');
    if (resultDiv) {
      resultDiv.innerHTML = '';
      resultDiv.appendChild(progressDiv);
    } else {
      // If no result div, just show toast
    ...
    reader.onprogress = function(event) {
      if (event.lengthComputable) {
        ...
        // Also update toast if it exists
