/* ============================================
   PROFILE.JS - MINIMAL TEST VERSION
   ============================================ */
...
console.log("  uploadBtnText:", !!uploadBtnText);
console.log("  saveAccountText:", !!saveAccountText);
...
/* ============================================
   UPLOAD PHOTO - MINIMAL TEST
   ============================================ */
if (uploadPhotoBtn && profilePhotoInput) {
  console.log("✅ Setting up Upload Photo (MINIMAL TEST)");
  
  // DIRECT click handler - ALWAYS WORKS
  uploadPhotoBtn.onclick = function(e) {
    e.preventDefault();
    console.log("📸 Upload button clicked - DIRECT");
...
/* ============================================
   SAVE ACCOUNT - MINIMAL TEST
   ============================================ */
if (saveAccountBtn) {
  console.log("✅ Setting up Save Account (MINIMAL TEST)");
  
  // DIRECT click handler - ALWAYS WORKS
  saveAccountBtn.onclick = async function(e) {
    e.preventDefault();
    console.log("💾 Save Account clicked - DIRECT");
...
console.log("📌 Upload Photo button innerHTML:", uploadPhotoBtn ? uploadPhotoBtn.innerHTML : 'Not found');
console.log("📌 Save Account button innerHTML:", saveAccountBtn ? saveAccountBtn.innerHTML : 'Not found');