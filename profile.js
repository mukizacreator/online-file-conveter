...
console.log("  saveAccountBtn exists:", !!saveAccountBtn);
console.log("  changePasswordBtn exists:", !!changePasswordBtn);
...
/* ============================================
   UPLOAD PHOTO BUTTON - WITH CONSOLE LOGS
   ============================================ */
if (uploadPhotoBtn && profilePhotoInput) {
  console.log("✅ Setting up Upload Photo button with console logs");
  ...
  // File change handler - with console logs
  profilePhotoInput.addEventListener("change", async function(e) {
    ...
    // ============================================
    // THIS IS THE CRITICAL PART - WITH CONSOLE LOGS
    // ============================================
    console.log("📸 Attempting to change button text...");
    ...
    try {
      ...
      console.log("📸 File read complete, uploading...");
      ...
      console.log("📸 Button restored to: 'Upload Photo'");
      ...
      this.disabled = false;
      this.textContent = "Upload Photo";
      console.log("📸 Button restored to: 'Upload Photo' (error)");
...
/* ============================================
   SAVE ACCOUNT BUTTON - WITH CONSOLE LOGS
   ============================================ */
if (saveAccountBtn) {
  console.log("✅ Setting up Save Account button with console logs");
  ...
  saveAccountBtn.addEventListener("click", async function() {
    ...
    try {
      ...
      if (!currentPassword) {
        ...
        console.log("💾 Button restored to: 'Save Changes' (no password)");
        return;
      }
      ...
      if (!verifyRes.ok) {
        ...
        this.disabled = false;
        this.textContent = "Save Changes";
        console.log("💾 Button restored to: 'Save Changes' (incorrect password)");
        return;
      }
      ...
      if (!newEmail && !newUsername) {
        ...
        this.disabled = false;
        this.textContent = "Save Changes";
        console.log("💾 Button restored to: 'Save Changes' (no changes)");
        return;
      }
      ...
      if (newEmail && newEmail !== currentUser.email) {
        ...
        if (checkRes.ok) {
          ...
          this.disabled = false;
          this.textContent = "Save Changes";
          console.log("💾 Button restored to: 'Save Changes' (email taken)");
          return;
        }
      }
      ...
      if (newUsername && newUsername.length < 3) {
        ...
        this.disabled = false;
        this.textContent = "Save Changes";
        console.log("💾 Button restored to: 'Save Changes' (username too short)");
        return;
      }
      ...
      if (!code) {
        ...
        this.disabled = false;
        this.textContent = "Save Changes";
        console.log("💾 Button restored to: 'Save Changes' (cancelled)");
        return;
      }
      ...
      if (!verifyData.success) {
        ...
        this.disabled = false;
        this.textContent = "Save Changes";
        console.log("💾 Button restored to: 'Save Changes' (wrong code)");
        return;
      }
      ...
      this.disabled = false;
      this.textContent = "Save Changes";
      console.log("💾 Button restored to: 'Save Changes' (success)");
      ...
      this.disabled = false;
      this.textContent = "Save Changes";
      console.log("💾 Button restored to: 'Save Changes' (error)");
