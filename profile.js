...
/* ============================================
   UPLOAD PHOTO - GLOBAL FUNCTION
   ============================================ */
function uploadPhotoClick() {
  console.log("📸 uploadPhotoClick called");
  // Change button text
...
if (uploadPhotoBtn && profilePhotoInput) {
  console.log("✅ Setting up Upload Photo listener");
...
async function saveAccountClick() {
  ...
  // NOW change button text after validation passes
