...
if (uploadPhotoBtn && profilePhotoInput) {
  ...
  profilePhotoInput.addEventListener("change", async function(e) {
    ...
    console.log("📸 Button changed to: Uploading...");
...
/* ============================================
   SAVE ACCOUNT BUTTON - FIXED (Same as Change Password)
   ============================================ */
if (saveAccountBtn) {
  ...
  saveAccountBtn.addEventListener("click", async function() {
    ...
    if (!verifyRes.ok) {
      ...
      this.disabled = false;
      this.textContent = "Save Changes";
      console.log("💾 Button restored to: Save Changes (wrong password)");
      return;
    }
    ...
    if (!newEmail && !newUsername) {
      ...
      this.disabled = false;
      this.textContent = "Save Changes";
      console.log("💾 Button restored to: Save Changes (no fields)");
      return;
    }
    ...
    if (newUsername && newUsername.length < 3) {
      ...
      this.disabled = false;
      this.textContent = "Save Changes";
      console.log("💾 Button restored to: Save Changes (username short)");
      return;
    }
    ...
    try {
      ...
      // REFRESH PAGE - THIS IS WHAT YOU WANTED
      setTimeout(function() {
