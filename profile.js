...
/* ============================================
   PROFILE PHOTO UPLOAD - WITH ALERT FOR DEBUGGING
   ============================================ */
if (uploadPhotoBtn && profilePhotoInput) {
  ...
  profilePhotoInput.addEventListener("change", function(e) {
    ...
    alert("File selected! (This is a test alert)");
...
/* ============================================
   SAVE ACCOUNT - WITH ALERT FOR DEBUGGING
   ============================================ */
if (saveAccountBtn) {
  ...
  saveAccountBtn.addEventListener("click", async function() {
    ...
    alert("Save Account button clicked! (This is a test alert)");
