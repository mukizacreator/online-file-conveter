...
function handlePhotoUpload() {
  console.log("📸 handlePhotoUpload called from onclick");
  document.getElementById('profilePhotoInput').click();
}

async function handleSaveAccount() {
  console.log("💾 handleSaveAccount called from onclick");
...
/* ============================================
   UPLOAD PHOTO - USING onclick HANDLER
   ============================================ */
...
/* ============================================
   SAVE ACCOUNT - Using onclick handler
   ============================================ */
// This is handled by the global function handleSaveAccount()
